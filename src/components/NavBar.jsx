      ...
      <div style={{
        ...
        <button onClick={() => goTo('home')}
          ...
          <div style={{ lineHeight: 1 }}>
            <div style={{ fontWeight: 900, fontSize: 15, color: '#1a1a1a', letterSpacing: 0.5 }}>ROCKIES</div>
        ...
        <div style={{ display: 'flex', gap: 2, alignItems: 'center' }}>
          ...
          <button onClick={() => goTo('order')}
            style={{
              marginLeft: 8, background: BRAND, color: 'white', border: 'none',
              borderRadius: 10, padding: '7px 16px', fontWeight: 900, fontSize: 13,
        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center', flexShrink: 0 }}>
          <button onClick={() => setLang(l => l === 'en' ? 'ar' : 'en')}
            style={{ background: '#f5f5f5', border: 'none', borderRadius: 8, padding: '5px 11px', fontWeight: 700, fontSize: 12, color: '#555', cursor: 'pointer' }}>
            {lang === 'ar' ? 'EN' : 'AR'}
          </button>
          <button onClick={onCart}
            style={{
              position: 'relative', background: BRAND, border: 'none', borderRadius: 10,
              width: 38, height: 38, display: 'flex', alignItems: 'center',
              justifyContent: 'center', cursor: 'pointer', color: 'white', transition: 'all .2s',
            }}
            onMouseEnter={e => e.currentTarget.style.background = '#7a0000'}
            onMouseLeave={e => e.currentTarget.style.background = BRAND}>
